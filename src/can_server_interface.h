...
/// BEGIN: Types as from former "wrapper_for_can_server_interface.h" directly put here, as we're building for PC only
...
/// BEGIN: HAL error codes from "hal/pc/errcodes.h" - make sure to NOT change these, also not in the client!
